                          ...
                          child:Container(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed:(selectedTime==0||selectedDay==0||selectedDayName=="")? null: (){
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => OrderDetails(iconImg,category,selectedService,selectedMonth,selectedDay,selectedDayName,selectedTime,userLoc)));
                                },
